...
const MIGRATIONS = ['001_init.sql', '002_uploads.sql', '003_notif_types.sql', '004_normalize_phone_cccd.sql', '005_phone_pad_10.sql', '006_vehicle_rental.sql', '007_composite_indexes.sql', '008_guest_role.sql', '009_cccd_back.sql'];
...
const BOOL_FIELDS = {
  accounts:      ['active'],
  students:      ['profileComplete', 'docs_cccd', 'docs_cccd_back', 'docs_gksk', 'docs_donDeNghi', 'docs_the3x4'],
